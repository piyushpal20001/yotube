 ...
 * `src/v23/custom_interest_service_client_config.json`.
...
class CustomInterestServiceClient {
     ...
     *     const client = new CustomInterestServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomInterestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customInterestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomInterestService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomInterestService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomInterests(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomInterests request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomInterests response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomInterests(request, options, wrappedCallback)
