 ...
 * `src/v23/ad_group_bid_modifier_service_client_config.json`.
...
class AdGroupBidModifierServiceClient {
     ...
     *     const client = new AdGroupBidModifierServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AdGroupBidModifierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AdGroupBidModifierService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AdGroupBidModifierService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupBidModifiers(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAdGroupBidModifiers response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAdGroupBidModifiers(request, options, wrappedCallback)
