...
exports.CampaignLifecycleGoalServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/campaign_lifecycle_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_lifecycle_goal_service_client_config.json");
...
class CampaignLifecycleGoalServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    campaignLifecycleGoalServiceStub;
    /**
     * Construct an instance of CampaignLifecycleGoalServiceClient.
     *
     ...
     *     const client = new CampaignLifecycleGoalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignLifecycleGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignLifecycleGoalServiceStub) {
            return this.campaignLifecycleGoalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.CampaignLifecycleGoalService.
        this.campaignLifecycleGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignLifecycleGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignLifecycleGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignLifecycleGoalServiceStubMethods = ['configureCampaignLifecycleGoals'];
        for (const methodName of campaignLifecycleGoalServiceStubMethods) {
            const callPromise = this.campaignLifecycleGoalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    configureCampaignLifecycleGoals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('configureCampaignLifecycleGoals request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('configureCampaignLifecycleGoals response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.configureCampaignLifecycleGoals(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.campaignLifecycleGoalServiceStub && !this._terminated) {
            return this.campaignLifecycleGoalServiceStub.then(stub => {
...
exports.CampaignLifecycleGoalServiceClient = CampaignLifecycleGoalServiceClient;
//# sourceMappingURL=campaign_lifecycle_goal_service_client.js.map