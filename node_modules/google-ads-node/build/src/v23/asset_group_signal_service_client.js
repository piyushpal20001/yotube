 ...
 * `src/v23/asset_group_signal_service_client_config.json`.
...
class AssetGroupSignalServiceClient {
     ...
     *     const client = new AssetGroupSignalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AssetGroupSignalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupSignalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AssetGroupSignalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AssetGroupSignalService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroupSignals(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAssetGroupSignals request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAssetGroupSignals response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAssetGroupSignals(request, options, wrappedCallback)
