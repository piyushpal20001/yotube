...
exports.AutomaticallyCreatedAssetRemovalServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/automatically_created_asset_removal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./automatically_created_asset_removal_service_client_config.json");
...
class AutomaticallyCreatedAssetRemovalServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    automaticallyCreatedAssetRemovalServiceStub;
    /**
     * Construct an instance of AutomaticallyCreatedAssetRemovalServiceClient.
     *
     ...
     *     const client = new AutomaticallyCreatedAssetRemovalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AutomaticallyCreatedAssetRemovalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.automaticallyCreatedAssetRemovalServiceStub) {
            return this.automaticallyCreatedAssetRemovalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.AutomaticallyCreatedAssetRemovalService.
        this.automaticallyCreatedAssetRemovalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AutomaticallyCreatedAssetRemovalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AutomaticallyCreatedAssetRemovalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const automaticallyCreatedAssetRemovalServiceStubMethods = ['removeCampaignAutomaticallyCreatedAsset'];
        for (const methodName of automaticallyCreatedAssetRemovalServiceStubMethods) {
            const callPromise = this.automaticallyCreatedAssetRemovalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    removeCampaignAutomaticallyCreatedAsset(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('removeCampaignAutomaticallyCreatedAsset request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('removeCampaignAutomaticallyCreatedAsset response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.removeCampaignAutomaticallyCreatedAsset(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.automaticallyCreatedAssetRemovalServiceStub && !this._terminated) {
            return this.automaticallyCreatedAssetRemovalServiceStub.then(stub => {
...
exports.AutomaticallyCreatedAssetRemovalServiceClient = AutomaticallyCreatedAssetRemovalServiceClient;
//# sourceMappingURL=automatically_created_asset_removal_service_client.js.map