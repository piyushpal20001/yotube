...
exports.CustomerAssetSetServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/customer_asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_asset_set_service_client_config.json");
...
class CustomerAssetSetServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    customerAssetSetServiceStub;
    /**
     * Construct an instance of CustomerAssetSetServiceClient.
     *
     ...
     *     const client = new CustomerAssetSetServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerAssetSetServiceStub) {
            return this.customerAssetSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.CustomerAssetSetService.
        this.customerAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerAssetSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerAssetSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerAssetSetServiceStubMethods = ['mutateCustomerAssetSets'];
        for (const methodName of customerAssetSetServiceStubMethods) {
            const callPromise = this.customerAssetSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCustomerAssetSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('mutateCustomerAssetSets request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerAssetSets response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerAssetSets(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.customerAssetSetServiceStub && !this._terminated) {
            return this.customerAssetSetServiceStub.then(stub => {
...
exports.CustomerAssetSetServiceClient = CustomerAssetSetServiceClient;
//# sourceMappingURL=customer_asset_set_service_client.js.map