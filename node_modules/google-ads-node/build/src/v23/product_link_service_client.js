...
exports.ProductLinkServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/product_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./product_link_service_client_config.json");
...
class ProductLinkServiceClient {
    ...
    /**
     * Construct an instance of ProductLinkServiceClient.
     *
     ...
     *     const client = new ProductLinkServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ProductLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.productLinkServiceStub) {
            return this.productLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.ProductLinkService.
        this.productLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ProductLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ProductLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const productLinkServiceStubMethods = ['createProductLink', 'removeProductLink'];
        for (const methodName of productLinkServiceStubMethods) {
            const callPromise = this.productLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createProductLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    removeProductLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=product_link_service_client.js.map