...
exports.BenchmarksServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/benchmarks_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./benchmarks_service_client_config.json");
...
class BenchmarksServiceClient {
    ...
    /**
     * Construct an instance of BenchmarksServiceClient.
     *
     ...
     *     const client = new BenchmarksServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            appliedIncentivePathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/appliedIncentives/{coupon_code}'),
            ...
            campaignGoalConfigPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/campaignGoalConfigs/{campaign_id}~{unified_goal_id}'),
            ...
            goalPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/goals/{unified_goal_id}'),
            ...
            matchedLocationInterestViewPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/matchedLocationInterestViews/{country_criterion_id}'),
            ...
            targetingExpansionViewPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/targetingExpansionViews/{campaign_id}~{targeting_expansion_type}'),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.BenchmarksService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.benchmarksServiceStub) {
            return this.benchmarksServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.BenchmarksService.
        this.benchmarksServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.BenchmarksService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.BenchmarksService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const benchmarksServiceStubMethods = ['listBenchmarksAvailableDates', 'listBenchmarksLocations', 'listBenchmarksProducts', 'listBenchmarksSources', 'generateBenchmarksMetrics'];
        for (const methodName of benchmarksServiceStubMethods) {
            const callPromise = this.benchmarksServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listBenchmarksAvailableDates(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('listBenchmarksAvailableDates request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listBenchmarksAvailableDates response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listBenchmarksAvailableDates(request, options, wrappedCallback)
    ...
    listBenchmarksLocations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        this.initialize().catch(err => { throw err; });
        this._log.info('listBenchmarksLocations request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listBenchmarksLocations response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listBenchmarksLocations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listBenchmarksLocations response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    listBenchmarksProducts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        this.initialize().catch(err => { throw err; });
        this._log.info('listBenchmarksProducts request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listBenchmarksProducts response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listBenchmarksProducts(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listBenchmarksProducts response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    listBenchmarksSources(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        this.initialize().catch(err => { throw err; });
        this._log.info('listBenchmarksSources request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listBenchmarksSources response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listBenchmarksSources(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listBenchmarksSources response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    generateBenchmarksMetrics(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('generateBenchmarksMetrics request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('generateBenchmarksMetrics response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.generateBenchmarksMetrics(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateBenchmarksMetrics response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
     ...
     * @returns {string} Resource name string.
     */
    appliedIncentivePath(customerId, couponCode) {
        return this.pathTemplates.appliedIncentivePathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromAppliedIncentiveName(appliedIncentiveName) {
        return this.pathTemplates.appliedIncentivePathTemplate.match(appliedIncentiveName).customer_id;
    }
    /**
     ...
     */
    matchCouponCodeFromAppliedIncentiveName(appliedIncentiveName) {
        return this.pathTemplates.appliedIncentivePathTemplate.match(appliedIncentiveName).coupon_code;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    campaignGoalConfigPath(customerId, campaignId, unifiedGoalId) {
        return this.pathTemplates.campaignGoalConfigPathTemplate.render({
            customer_id: customerId,
            campaign_id: campaignId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromCampaignGoalConfigName(campaignGoalConfigName) {
        return this.pathTemplates.campaignGoalConfigPathTemplate.match(campaignGoalConfigName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the campaign_id.
     */
    matchCampaignIdFromCampaignGoalConfigName(campaignGoalConfigName) {
        return this.pathTemplates.campaignGoalConfigPathTemplate.match(campaignGoalConfigName).campaign_id;
    }
    /**
     ...
     */
    matchUnifiedGoalIdFromCampaignGoalConfigName(campaignGoalConfigName) {
        return this.pathTemplates.campaignGoalConfigPathTemplate.match(campaignGoalConfigName).unified_goal_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    campaignSearchTermViewPath(customerId, campaignId, query) {
        return this.pathTemplates.campaignSearchTermViewPathTemplate.render({
            customer_id: customerId,
            campaign_id: campaignId,
            query: query,
        });
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromCampaignSearchTermViewName(campaignSearchTermViewName) {
        return this.pathTemplates.campaignSearchTermViewPathTemplate.match(campaignSearchTermViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the campaign_id.
     */
    matchCampaignIdFromCampaignSearchTermViewName(campaignSearchTermViewName) {
        return this.pathTemplates.campaignSearchTermViewPathTemplate.match(campaignSearchTermViewName).campaign_id;
    }
    /**
     ...
     */
    matchQueryFromCampaignSearchTermViewName(campaignSearchTermViewName) {
        return this.pathTemplates.campaignSearchTermViewPathTemplate.match(campaignSearchTermViewName).query;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    channelAggregateAssetViewPath(customerId, advertisingChannelType, assetId, assetSource, fieldType) {
        return this.pathTemplates.channelAggregateAssetViewPathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromChannelAggregateAssetViewName(channelAggregateAssetViewName) {
        return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(channelAggregateAssetViewName).customer_id;
    }
    /**
     ...
     */
    matchAdvertisingChannelTypeFromChannelAggregateAssetViewName(channelAggregateAssetViewName) {
        return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(channelAggregateAssetViewName).advertising_channel_type;
    }
    /**
     ...
     * @returns {string} A string representing the asset_id.
     */
    matchAssetIdFromChannelAggregateAssetViewName(channelAggregateAssetViewName) {
        return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(channelAggregateAssetViewName).asset_id;
    }
    /**
     ...
     */
    matchAssetSourceFromChannelAggregateAssetViewName(channelAggregateAssetViewName) {
        return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(channelAggregateAssetViewName).asset_source;
    }
    /**
     ...
     * @returns {string} A string representing the field_type.
     */
    matchFieldTypeFromChannelAggregateAssetViewName(channelAggregateAssetViewName) {
        return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(channelAggregateAssetViewName).field_type;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    contentCriterionViewPath(customerId, adGroupId, criterionId) {
        return this.pathTemplates.contentCriterionViewPathTemplate.render({
            customer_id: customerId,
            ad_group_id: adGroupId,
            criterion_id: criterionId,
        });
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromContentCriterionViewName(contentCriterionViewName) {
        return this.pathTemplates.contentCriterionViewPathTemplate.match(contentCriterionViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the ad_group_id.
     */
    matchAdGroupIdFromContentCriterionViewName(contentCriterionViewName) {
        return this.pathTemplates.contentCriterionViewPathTemplate.match(contentCriterionViewName).ad_group_id;
    }
    /**
     ...
     * @returns {string} A string representing the criterion_id.
     */
    matchCriterionIdFromContentCriterionViewName(contentCriterionViewName) {
        return this.pathTemplates.contentCriterionViewPathTemplate.match(contentCriterionViewName).criterion_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    dataLinkPath(customerId, productLinkId, dataLinkId) {
        return this.pathTemplates.dataLinkPathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromDataLinkName(dataLinkName) {
        return this.pathTemplates.dataLinkPathTemplate.match(dataLinkName).customer_id;
    }
    /**
     ...
     */
    matchProductLinkIdFromDataLinkName(dataLinkName) {
        return this.pathTemplates.dataLinkPathTemplate.match(dataLinkName).product_link_id;
    }
    /**
     ...
     */
    matchDataLinkIdFromDataLinkName(dataLinkName) {
        return this.pathTemplates.dataLinkPathTemplate.match(dataLinkName).data_link_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    detailContentSuitabilityPlacementViewPath(customerId, placementFingerprint) {
        return this.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.render({
            customer_id: customerId,
            placement_fingerprint: placementFingerprint,
        });
    }
    /**
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromDetailContentSuitabilityPlacementViewName(detailContentSuitabilityPlacementViewName) {
        return this.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match(detailContentSuitabilityPlacementViewName).customer_id;
    }
    /**
     ...
     */
    matchPlacementFingerprintFromDetailContentSuitabilityPlacementViewName(detailContentSuitabilityPlacementViewName) {
        return this.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match(detailContentSuitabilityPlacementViewName).placement_fingerprint;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    finalUrlExpansionAssetViewPath(customerId, campaignId, assetId, fieldType, urlFp) {
        return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.render({
            customer_id: customerId,
            campaign_id: campaignId,
            asset_id: assetId,
            field_type: fieldType,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromFinalUrlExpansionAssetViewName(finalUrlExpansionAssetViewName) {
        return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(finalUrlExpansionAssetViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the campaign_id.
     */
    matchCampaignIdFromFinalUrlExpansionAssetViewName(finalUrlExpansionAssetViewName) {
        return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(finalUrlExpansionAssetViewName).campaign_id;
    }
    /**
     ...
     * @returns {string} A string representing the asset_id.
     */
    matchAssetIdFromFinalUrlExpansionAssetViewName(finalUrlExpansionAssetViewName) {
        return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(finalUrlExpansionAssetViewName).asset_id;
    }
    /**
     ...
     * @returns {string} A string representing the field_type.
     */
    matchFieldTypeFromFinalUrlExpansionAssetViewName(finalUrlExpansionAssetViewName) {
        return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(finalUrlExpansionAssetViewName).field_type;
    }
    /**
     ...
     */
    matchUrlFpFromFinalUrlExpansionAssetViewName(finalUrlExpansionAssetViewName) {
        return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(finalUrlExpansionAssetViewName).url_fp;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    goalPath(customerId, unifiedGoalId) {
        return this.pathTemplates.goalPathTemplate.render({
            customer_id: customerId,
            unified_goal_id: unifiedGoalId,
        });
    }
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromGoalName(goalName) {
        return this.pathTemplates.goalPathTemplate.match(goalName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the unified_goal_id.
     */
    matchUnifiedGoalIdFromGoalName(goalName) {
        return this.pathTemplates.goalPathTemplate.match(goalName).unified_goal_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    groupContentSuitabilityPlacementViewPath(customerId, placementFingerprint) {
        return this.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.render({
            customer_id: customerId,
            placement_fingerprint: placementFingerprint,
        });
    }
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromGroupContentSuitabilityPlacementViewName(groupContentSuitabilityPlacementViewName) {
        return this.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match(groupContentSuitabilityPlacementViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the placement_fingerprint.
     */
    matchPlacementFingerprintFromGroupContentSuitabilityPlacementViewName(groupContentSuitabilityPlacementViewName) {
        return this.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match(groupContentSuitabilityPlacementViewName).placement_fingerprint;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    localServicesEmployeePath(customerId, glsEmployeeId) {
        return this.pathTemplates.localServicesEmployeePathTemplate.render({
            customer_id: customerId,
            gls_employee_id: glsEmployeeId,
        });
    }
    /**
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromLocalServicesEmployeeName(localServicesEmployeeName) {
        return this.pathTemplates.localServicesEmployeePathTemplate.match(localServicesEmployeeName).customer_id;
    }
    /**
     ...
     */
    matchGlsEmployeeIdFromLocalServicesEmployeeName(localServicesEmployeeName) {
        return this.pathTemplates.localServicesEmployeePathTemplate.match(localServicesEmployeeName).gls_employee_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    locationInterestViewPath(customerId, campaignId, adGroupId, criterionId) {
        return this.pathTemplates.locationInterestViewPathTemplate.render({
            customer_id: customerId,
            campaign_id: campaignId,
            ad_group_id: adGroupId,
            criterion_id: criterionId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromLocationInterestViewName(locationInterestViewName) {
        return this.pathTemplates.locationInterestViewPathTemplate.match(locationInterestViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the campaign_id.
     */
    matchCampaignIdFromLocationInterestViewName(locationInterestViewName) {
        return this.pathTemplates.locationInterestViewPathTemplate.match(locationInterestViewName).campaign_id;
    }
    /**
     ...
     * @returns {string} A string representing the ad_group_id.
     */
    matchAdGroupIdFromLocationInterestViewName(locationInterestViewName) {
        return this.pathTemplates.locationInterestViewPathTemplate.match(locationInterestViewName).ad_group_id;
    }
    /**
     ...
     * @returns {string} A string representing the criterion_id.
     */
    matchCriterionIdFromLocationInterestViewName(locationInterestViewName) {
        return this.pathTemplates.locationInterestViewPathTemplate.match(locationInterestViewName).criterion_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    matchedLocationInterestViewPath(customerId, countryCriterionId) {
        return this.pathTemplates.matchedLocationInterestViewPathTemplate.render({
            customer_id: customerId,
            country_criterion_id: countryCriterionId,
        });
    }
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromMatchedLocationInterestViewName(matchedLocationInterestViewName) {
        return this.pathTemplates.matchedLocationInterestViewPathTemplate.match(matchedLocationInterestViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the country_criterion_id.
     */
    matchCountryCriterionIdFromMatchedLocationInterestViewName(matchedLocationInterestViewName) {
        return this.pathTemplates.matchedLocationInterestViewPathTemplate.match(matchedLocationInterestViewName).country_criterion_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    offlineConversionUploadConversionActionSummaryPath(customerId, conversionTypeId, client) {
        return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromOfflineConversionUploadConversionActionSummaryName(offlineConversionUploadConversionActionSummaryName) {
        return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match(offlineConversionUploadConversionActionSummaryName).customer_id;
    }
    /**
     ...
     */
    matchConversionTypeIdFromOfflineConversionUploadConversionActionSummaryName(offlineConversionUploadConversionActionSummaryName) {
        return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match(offlineConversionUploadConversionActionSummaryName).conversion_type_id;
    }
    /**
     ...
     * @returns {string} A string representing the client.
     */
    matchClientFromOfflineConversionUploadConversionActionSummaryName(offlineConversionUploadConversionActionSummaryName) {
        return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match(offlineConversionUploadConversionActionSummaryName).client;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    performanceMaxPlacementViewPath(customerId) {
        return this.pathTemplates.performanceMaxPlacementViewPathTemplate.render({
            customer_id: customerId,
        });
    }
    /**
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromPerformanceMaxPlacementViewName(performanceMaxPlacementViewName) {
        return this.pathTemplates.performanceMaxPlacementViewPathTemplate.match(performanceMaxPlacementViewName).customer_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    shoppingProductPath(customerId, merchantCenterId, channel, languageCode, feedLabel, itemId) {
        return this.pathTemplates.shoppingProductPathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromShoppingProductName(shoppingProductName) {
        return this.pathTemplates.shoppingProductPathTemplate.match(shoppingProductName).customer_id;
    }
    /**
     ...
     */
    matchMerchantCenterIdFromShoppingProductName(shoppingProductName) {
        return this.pathTemplates.shoppingProductPathTemplate.match(shoppingProductName).merchant_center_id;
    }
    /**
     ...
     */
    matchChannelFromShoppingProductName(shoppingProductName) {
        return this.pathTemplates.shoppingProductPathTemplate.match(shoppingProductName).channel;
    }
    /**
     ...
     * @returns {string} A string representing the language_code.
     */
    matchLanguageCodeFromShoppingProductName(shoppingProductName) {
        return this.pathTemplates.shoppingProductPathTemplate.match(shoppingProductName).language_code;
    }
    /**
     ...
     */
    matchFeedLabelFromShoppingProductName(shoppingProductName) {
        return this.pathTemplates.shoppingProductPathTemplate.match(shoppingProductName).feed_label;
    }
    /**
     ...
     */
    matchItemIdFromShoppingProductName(shoppingProductName) {
        return this.pathTemplates.shoppingProductPathTemplate.match(shoppingProductName).item_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    targetingExpansionViewPath(customerId, campaignId, targetingExpansionType) {
        return this.pathTemplates.targetingExpansionViewPathTemplate.render({
            customer_id: customerId,
            campaign_id: campaignId,
            targeting_expansion_type: targetingExpansionType,
        });
    }
    /**
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromTargetingExpansionViewName(targetingExpansionViewName) {
        return this.pathTemplates.targetingExpansionViewPathTemplate.match(targetingExpansionViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the campaign_id.
     */
    matchCampaignIdFromTargetingExpansionViewName(targetingExpansionViewName) {
        return this.pathTemplates.targetingExpansionViewPathTemplate.match(targetingExpansionViewName).campaign_id;
    }
    /**
     ...
     */
    matchTargetingExpansionTypeFromTargetingExpansionViewName(targetingExpansionViewName) {
        return this.pathTemplates.targetingExpansionViewPathTemplate.match(targetingExpansionViewName).targeting_expansion_type;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    userListCustomerTypePath(customerId, userListId, semanticLabel) {
        return this.pathTemplates.userListCustomerTypePathTemplate.render({
            customer_id: customerId,
            user_list_id: userListId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromUserListCustomerTypeName(userListCustomerTypeName) {
        return this.pathTemplates.userListCustomerTypePathTemplate.match(userListCustomerTypeName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the user_list_id.
     */
    matchUserListIdFromUserListCustomerTypeName(userListCustomerTypeName) {
        return this.pathTemplates.userListCustomerTypePathTemplate.match(userListCustomerTypeName).user_list_id;
    }
    /**
     ...
     */
    matchSemanticLabelFromUserListCustomerTypeName(userListCustomerTypeName) {
        return this.pathTemplates.userListCustomerTypePathTemplate.match(userListCustomerTypeName).semantic_label;
    }
    /**
     ...
     */
    close() {
        if (this.benchmarksServiceStub && !this._terminated) {
            return this.benchmarksServiceStub.then(stub => {
...
exports.BenchmarksServiceClient = BenchmarksServiceClient;
//# sourceMappingURL=benchmarks_service_client.js.map