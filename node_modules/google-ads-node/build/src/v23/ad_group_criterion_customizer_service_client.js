 ...
 * `src/v23/ad_group_criterion_customizer_service_client_config.json`.
...
class AdGroupCriterionCustomizerServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    adGroupCriterionCustomizerServiceStub;
    /**
     ...
     *     const client = new AdGroupCriterionCustomizerServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AdGroupCriterionCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCriterionCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AdGroupCriterionCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AdGroupCriterionCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupCriterionCustomizers(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAdGroupCriterionCustomizers request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAdGroupCriterionCustomizers response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAdGroupCriterionCustomizers(request, options, wrappedCallback)
