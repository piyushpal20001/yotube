...
exports.TravelAssetSuggestionServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/travel_asset_suggestion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./travel_asset_suggestion_service_client_config.json");
...
class TravelAssetSuggestionServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    travelAssetSuggestionServiceStub;
    /**
     * Construct an instance of TravelAssetSuggestionServiceClient.
     *
     ...
     *     const client = new TravelAssetSuggestionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.TravelAssetSuggestionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.travelAssetSuggestionServiceStub) {
            return this.travelAssetSuggestionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.TravelAssetSuggestionService.
        this.travelAssetSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.TravelAssetSuggestionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.TravelAssetSuggestionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const travelAssetSuggestionServiceStubMethods = ['suggestTravelAssets'];
        for (const methodName of travelAssetSuggestionServiceStubMethods) {
            const callPromise = this.travelAssetSuggestionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    suggestTravelAssets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('suggestTravelAssets request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('suggestTravelAssets response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.suggestTravelAssets(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.travelAssetSuggestionServiceStub && !this._terminated) {
            return this.travelAssetSuggestionServiceStub.then(stub => {
...
exports.TravelAssetSuggestionServiceClient = TravelAssetSuggestionServiceClient;
//# sourceMappingURL=travel_asset_suggestion_service_client.js.map