 ...
 * `src/v23/customer_customizer_service_client_config.json`.
...
class CustomerCustomizerServiceClient {
     ...
     *     const client = new CustomerCustomizerServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerCustomizers(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomerCustomizers request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerCustomizers response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerCustomizers(request, options, wrappedCallback)
