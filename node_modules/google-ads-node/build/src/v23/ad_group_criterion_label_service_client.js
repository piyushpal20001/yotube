 ...
 * `src/v23/ad_group_criterion_label_service_client_config.json`.
...
class AdGroupCriterionLabelServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    adGroupCriterionLabelServiceStub;
    /**
     ...
     *     const client = new AdGroupCriterionLabelServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AdGroupCriterionLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCriterionLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AdGroupCriterionLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AdGroupCriterionLabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupCriterionLabels(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAdGroupCriterionLabels request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAdGroupCriterionLabels response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAdGroupCriterionLabels(request, options, wrappedCallback)
