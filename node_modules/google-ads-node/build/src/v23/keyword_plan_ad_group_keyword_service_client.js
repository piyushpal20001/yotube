 ...
 * `src/v23/keyword_plan_ad_group_keyword_service_client_config.json`.
...
class KeywordPlanAdGroupKeywordServiceClient {
     ...
     *     const client = new KeywordPlanAdGroupKeywordServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanAdGroupKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordService, this._opts, this._providedCustomServicePath);
