 ...
 * `src/v23/keyword_plan_campaign_keyword_service_client_config.json`.
...
class KeywordPlanCampaignKeywordServiceClient {
     ...
     *     const client = new KeywordPlanCampaignKeywordServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.KeywordPlanCampaignKeywordService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanCampaignKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.KeywordPlanCampaignKeywordService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.KeywordPlanCampaignKeywordService, this._opts, this._providedCustomServicePath);
    ...
    mutateKeywordPlanCampaignKeywords(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateKeywordPlanCampaignKeywords request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateKeywordPlanCampaignKeywords response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateKeywordPlanCampaignKeywords(request, options, wrappedCallback)
