 ...
 * `src/v23/keyword_plan_idea_service_client_config.json`.
...
class KeywordPlanIdeaServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.KeywordPlanIdeaService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.KeywordPlanIdeaService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.KeywordPlanIdeaService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanIdeaServiceStubMethods = ['generateKeywordIdeas', 'generateKeywordHistoricalMetrics', 'generateAdGroupThemes', 'generateKeywordForecastMetrics'];
    ...
    generateKeywordForecastMetrics(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @param {google.ads.googleads.v23.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork} request.keyword_planNetwork
     *   Targeting network.
     *   If not set, Google Search And Partners Network will be used.
     * @param {number[]} request.keywordAnnotation
     *   The keyword annotations to include in response.
     * @param {google.ads.googleads.v23.common.KeywordPlanAggregateMetrics} request.aggregateMetrics
     *   The aggregate fields to include in response.
     * @param {google.ads.googleads.v23.common.HistoricalMetricsOptions} request.historicalMetricsOptions
     *   The options for historical metrics data.
     * @param {google.ads.googleads.v23.services.KeywordAndUrlSeed} request.keywordAndUrlSeed
     *   A Keyword and a specific Url to generate ideas from
     *   for example, cars, www.example.com/cars.
     * @param {google.ads.googleads.v23.services.KeywordSeed} request.keywordSeed
     *   A Keyword or phrase to generate ideas from, for example, cars.
     * @param {google.ads.googleads.v23.services.UrlSeed} request.urlSeed
     *   A specific url to generate ideas from, for example, www.example.com/cars.
     * @param {google.ads.googleads.v23.services.SiteSeed} request.siteSeed
     *   The site to generate ideas from, for example, www.example.com.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.ads.googleads.v23.services.GenerateKeywordIdeaResult|GenerateKeywordIdeaResult} on 'data' event.
     ...
     *   {@link protos.google.ads.googleads.v23.services.GenerateKeywordIdeaResult|GenerateKeywordIdeaResult}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v23/keyword_plan_idea_service.generate_keyword_ideas.js</caption>
     * region_tag:googleads_v23_generated_KeywordPlanIdeaService_GenerateKeywordIdeas_async
     */
