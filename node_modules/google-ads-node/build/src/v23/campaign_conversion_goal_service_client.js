 ...
 * `src/v23/campaign_conversion_goal_service_client_config.json`.
...
class CampaignConversionGoalServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    campaignConversionGoalServiceStub;
    /**
     ...
     *     const client = new CampaignConversionGoalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignConversionGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignConversionGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignConversionGoalService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignConversionGoals(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCampaignConversionGoals request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCampaignConversionGoals response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCampaignConversionGoals(request, options, wrappedCallback)
