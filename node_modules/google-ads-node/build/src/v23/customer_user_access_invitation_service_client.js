 ...
 * `src/v23/customer_user_access_invitation_service_client_config.json`.
...
class CustomerUserAccessInvitationServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    customerUserAccessInvitationServiceStub;
    /**
     ...
     *     const client = new CustomerUserAccessInvitationServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerUserAccessInvitationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerUserAccessInvitationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerUserAccessInvitationService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerUserAccessInvitation(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomerUserAccessInvitation request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerUserAccessInvitation response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerUserAccessInvitation(request, options, wrappedCallback)
