 ...
 * `src/v23/keyword_theme_constant_service_client_config.json`.
...
class KeywordThemeConstantServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    keywordThemeConstantServiceStub;
    /**
     ...
     *     const client = new KeywordThemeConstantServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.KeywordThemeConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.KeywordThemeConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.KeywordThemeConstantService, this._opts, this._providedCustomServicePath);
    ...
    suggestKeywordThemeConstants(request, optionsOrCallback, callback) {
        ...
        this._log.info('suggestKeywordThemeConstants request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('suggestKeywordThemeConstants response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.suggestKeywordThemeConstants(request, options, wrappedCallback)
