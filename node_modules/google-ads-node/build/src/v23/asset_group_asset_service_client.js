 ...
 * `src/v23/asset_group_asset_service_client_config.json`.
...
class AssetGroupAssetServiceClient {
     ...
     *     const client = new AssetGroupAssetServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AssetGroupAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AssetGroupAssetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AssetGroupAssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroupAssets(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAssetGroupAssets request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAssetGroupAssets response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAssetGroupAssets(request, options, wrappedCallback)
