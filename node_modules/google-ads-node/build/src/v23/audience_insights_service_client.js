 ...
 * `src/v23/audience_insights_service_client_config.json`.
...
class AudienceInsightsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AudienceInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.audienceInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AudienceInsightsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AudienceInsightsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const audienceInsightsServiceStubMethods = ['generateInsightsFinderReport', 'listAudienceInsightsAttributes', 'listInsightsEligibleDates', 'generateAudienceCompositionInsights', 'generateAudienceDefinition', 'generateSuggestedTargetingInsights', 'generateAudienceOverlapInsights', 'generateTargetingSuggestionMetrics'];
    ...
    listInsightsEligibleDates(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    generateAudienceDefinition(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('generateAudienceDefinition request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('generateAudienceDefinition response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.generateAudienceDefinition(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateAudienceDefinition response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    generateSuggestedTargetingInsights(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    generateAudienceOverlapInsights(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    generateTargetingSuggestionMetrics(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
