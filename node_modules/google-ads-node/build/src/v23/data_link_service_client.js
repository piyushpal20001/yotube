...
exports.DataLinkServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/data_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./data_link_service_client_config.json");
...
class DataLinkServiceClient {
    ...
    dataLinkServiceStub;
    /**
     * Construct an instance of DataLinkServiceClient.
     *
     ...
     *     const client = new DataLinkServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.DataLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.dataLinkServiceStub) {
            return this.dataLinkServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.DataLinkService.
        this.dataLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.DataLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.DataLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const dataLinkServiceStubMethods = ['createDataLink', 'removeDataLink', 'updateDataLink'];
        for (const methodName of dataLinkServiceStubMethods) {
            const callPromise = this.dataLinkServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createDataLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    removeDataLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateDataLink(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.DataLinkServiceClient = DataLinkServiceClient;
//# sourceMappingURL=data_link_service_client.js.map