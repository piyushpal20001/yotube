 ...
 * `src/v23/ad_group_customizer_service_client_config.json`.
...
class AdGroupCustomizerServiceClient {
     ...
     *     const client = new AdGroupCustomizerServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AdGroupCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AdGroupCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AdGroupCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupCustomizers(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAdGroupCustomizers request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAdGroupCustomizers response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAdGroupCustomizers(request, options, wrappedCallback)
