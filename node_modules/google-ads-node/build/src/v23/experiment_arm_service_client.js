 ...
 * `src/v23/experiment_arm_service_client_config.json`.
...
class ExperimentArmServiceClient {
     ...
     *     const client = new ExperimentArmServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ExperimentArmService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.experimentArmServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ExperimentArmService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ExperimentArmService, this._opts, this._providedCustomServicePath);
    ...
    mutateExperimentArms(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateExperimentArms request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateExperimentArms response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateExperimentArms(request, options, wrappedCallback)
