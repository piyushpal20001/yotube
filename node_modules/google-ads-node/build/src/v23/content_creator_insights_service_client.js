...
exports.ContentCreatorInsightsServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/content_creator_insights_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./content_creator_insights_service_client_config.json");
...
class ContentCreatorInsightsServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    contentCreatorInsightsServiceStub;
    /**
     * Construct an instance of ContentCreatorInsightsServiceClient.
     *
     ...
     *     const client = new ContentCreatorInsightsServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ContentCreatorInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.contentCreatorInsightsServiceStub) {
            return this.contentCreatorInsightsServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.ContentCreatorInsightsService.
        this.contentCreatorInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ContentCreatorInsightsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ContentCreatorInsightsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const contentCreatorInsightsServiceStubMethods = ['generateCreatorInsights', 'generateTrendingInsights'];
        for (const methodName of contentCreatorInsightsServiceStubMethods) {
            const callPromise = this.contentCreatorInsightsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateCreatorInsights(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    generateTrendingInsights(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.ContentCreatorInsightsServiceClient = ContentCreatorInsightsServiceClient;
//# sourceMappingURL=content_creator_insights_service_client.js.map