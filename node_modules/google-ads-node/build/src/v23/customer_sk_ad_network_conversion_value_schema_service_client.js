...
exports.CustomerSkAdNetworkConversionValueSchemaServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/customer_sk_ad_network_conversion_value_schema_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_sk_ad_network_conversion_value_schema_service_client_config.json");
...
class CustomerSkAdNetworkConversionValueSchemaServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    customerSkAdNetworkConversionValueSchemaServiceStub;
    /**
     * Construct an instance of CustomerSkAdNetworkConversionValueSchemaServiceClient.
     *
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerSkAdNetworkConversionValueSchemaService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerSkAdNetworkConversionValueSchemaServiceStub) {
            return this.customerSkAdNetworkConversionValueSchemaServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.CustomerSkAdNetworkConversionValueSchemaService.
        this.customerSkAdNetworkConversionValueSchemaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerSkAdNetworkConversionValueSchemaService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerSkAdNetworkConversionValueSchemaService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerSkAdNetworkConversionValueSchemaServiceStubMethods = ['mutateCustomerSkAdNetworkConversionValueSchema'];
        for (const methodName of customerSkAdNetworkConversionValueSchemaServiceStubMethods) {
            const callPromise = this.customerSkAdNetworkConversionValueSchemaServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCustomerSkAdNetworkConversionValueSchema(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('mutateCustomerSkAdNetworkConversionValueSchema request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerSkAdNetworkConversionValueSchema response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerSkAdNetworkConversionValueSchema(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.customerSkAdNetworkConversionValueSchemaServiceStub && !this._terminated) {
            return this.customerSkAdNetworkConversionValueSchemaServiceStub.then(stub => {
...
exports.CustomerSkAdNetworkConversionValueSchemaServiceClient = CustomerSkAdNetworkConversionValueSchemaServiceClient;
//# sourceMappingURL=customer_sk_ad_network_conversion_value_schema_service_client.js.map