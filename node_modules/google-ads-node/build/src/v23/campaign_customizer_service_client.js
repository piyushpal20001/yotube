 ...
 * `src/v23/campaign_customizer_service_client_config.json`.
...
class CampaignCustomizerServiceClient {
     ...
     *     const client = new CampaignCustomizerServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignCustomizers(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCampaignCustomizers request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCampaignCustomizers response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCampaignCustomizers(request, options, wrappedCallback)
