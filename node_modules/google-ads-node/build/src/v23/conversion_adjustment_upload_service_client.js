 ...
 * `src/v23/conversion_adjustment_upload_service_client_config.json`.
...
class ConversionAdjustmentUploadServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ConversionAdjustmentUploadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionAdjustmentUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ConversionAdjustmentUploadService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ConversionAdjustmentUploadService, this._opts, this._providedCustomServicePath);
    ...
    uploadConversionAdjustments(request, optionsOrCallback, callback) {
        ...
        this._log.info('uploadConversionAdjustments request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('uploadConversionAdjustments response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.uploadConversionAdjustments(request, options, wrappedCallback)
