 ...
 * `src/v23/asset_group_listing_group_filter_service_client_config.json`.
...
class AssetGroupListingGroupFilterServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    assetGroupListingGroupFilterServiceStub;
    /**
     ...
     *     const client = new AssetGroupListingGroupFilterServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AssetGroupListingGroupFilterService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupListingGroupFilterServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AssetGroupListingGroupFilterService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AssetGroupListingGroupFilterService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroupListingGroupFilters(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAssetGroupListingGroupFilters request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAssetGroupListingGroupFilters response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAssetGroupListingGroupFilters(request, options, wrappedCallback)
