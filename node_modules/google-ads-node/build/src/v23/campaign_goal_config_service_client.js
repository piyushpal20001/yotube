...
exports.CampaignGoalConfigServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/campaign_goal_config_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_goal_config_service_client_config.json");
...
class CampaignGoalConfigServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    campaignGoalConfigServiceStub;
    /**
     * Construct an instance of CampaignGoalConfigServiceClient.
     *
     ...
     *     const client = new CampaignGoalConfigServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignGoalConfigService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignGoalConfigServiceStub) {
            return this.campaignGoalConfigServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.CampaignGoalConfigService.
        this.campaignGoalConfigServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignGoalConfigService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignGoalConfigService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignGoalConfigServiceStubMethods = ['mutateCampaignGoalConfigs'];
        for (const methodName of campaignGoalConfigServiceStubMethods) {
            const callPromise = this.campaignGoalConfigServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCampaignGoalConfigs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('mutateCampaignGoalConfigs request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCampaignGoalConfigs response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCampaignGoalConfigs(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.campaignGoalConfigServiceStub && !this._terminated) {
            return this.campaignGoalConfigServiceStub.then(stub => {
...
exports.CampaignGoalConfigServiceClient = CampaignGoalConfigServiceClient;
//# sourceMappingURL=campaign_goal_config_service_client.js.map