 ...
 * `src/v23/customer_client_link_service_client_config.json`.
...
class CustomerClientLinkServiceClient {
     ...
     *     const client = new CustomerClientLinkServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerClientLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerClientLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerClientLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerClientLinkService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerClientLink(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomerClientLink request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerClientLink response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerClientLink(request, options, wrappedCallback)
