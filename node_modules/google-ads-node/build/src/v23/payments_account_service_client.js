 ...
 * `src/v23/payments_account_service_client_config.json`.
...
class PaymentsAccountServiceClient {
     ...
     *     const client = new PaymentsAccountServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.PaymentsAccountService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.paymentsAccountServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.PaymentsAccountService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.PaymentsAccountService, this._opts, this._providedCustomServicePath);
    ...
    listPaymentsAccounts(request, optionsOrCallback, callback) {
        ...
        this._log.info('listPaymentsAccounts request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listPaymentsAccounts response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listPaymentsAccounts(request, options, wrappedCallback)
