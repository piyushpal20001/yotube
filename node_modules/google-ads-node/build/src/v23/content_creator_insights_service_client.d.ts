 ...
 * @memberof v23
 */
export declare class ContentCreatorInsightsServiceClient {
    private _terminated;
    private _opts;
    ...
    contentCreatorInsightsServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     * @param {number[]} request.countryLocations
     *   Required. The countries to search that apply to the criteria.
     * @param {number[]} request.subCountryLocations
     *   The sub-country geographic locations to search that apply to the criteria.
     *   Only supported for
     *   {@link protos.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchAttributes|SearchAttributes}
     *   criteria.
     * @param {google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchAttributes} request.searchAttributes
     ...
     *   {@link protos.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.country_locations|country_locations}
     *   or
     *   {@link protos.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.sub_country_locations|sub_country_locations}.
     * @param {google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchBrand} request.searchBrand
     *   A brand used to search for top creators. Data fetched is based on the
     *   list of countries specified in
     *   {@link protos.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.country_locations|country_locations}.
     * @param {google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.YouTubeChannels} request.searchChannels
     ...
     *   The first element of the array is an object representing {@link protos.google.ads.googleads.v23.services.GenerateCreatorInsightsResponse|GenerateCreatorInsightsResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v23/content_creator_insights_service.generate_creator_insights.js</caption>
     * region_tag:googleads_v23_generated_ContentCreatorInsightsService_GenerateCreatorInsights_async
     */
    generateCreatorInsights(request?: protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsResponse,
        protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsRequest | undefined,
        {} | undefined
    ]>;
    generateCreatorInsights(request: protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsResponse, protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsRequest | null | undefined, {} | null | undefined>): void;
    generateCreatorInsights(request: protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsRequest, callback: Callback<protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsResponse, protos.google.ads.googleads.v23.services.IGenerateCreatorInsightsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @param {google.ads.googleads.v23.services.SearchAudience} request.searchAudience
     *   An audience to search for trending content in.
     * @param {google.ads.googleads.v23.services.SearchTopics} request.searchTopics
     *   Content topics to return trend information for.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.ads.googleads.v23.services.GenerateTrendingInsightsResponse|GenerateTrendingInsightsResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v23/content_creator_insights_service.generate_trending_insights.js</caption>
     * region_tag:googleads_v23_generated_ContentCreatorInsightsService_GenerateTrendingInsights_async
     */
    generateTrendingInsights(request?: protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsResponse,
        protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsRequest | undefined,
        {} | undefined
    ]>;
    generateTrendingInsights(request: protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsResponse, protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsRequest | null | undefined, {} | null | undefined>): void;
    generateTrendingInsights(request: protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsRequest, callback: Callback<protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsResponse, protos.google.ads.googleads.v23.services.IGenerateTrendingInsightsRequest | null | undefined, {} | null | undefined>): void;
    /**
