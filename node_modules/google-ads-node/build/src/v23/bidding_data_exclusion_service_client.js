 ...
 * `src/v23/bidding_data_exclusion_service_client_config.json`.
...
class BiddingDataExclusionServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    biddingDataExclusionServiceStub;
    /**
     ...
     *     const client = new BiddingDataExclusionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.BiddingDataExclusionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.biddingDataExclusionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.BiddingDataExclusionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.BiddingDataExclusionService, this._opts, this._providedCustomServicePath);
    ...
    mutateBiddingDataExclusions(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateBiddingDataExclusions request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateBiddingDataExclusions response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateBiddingDataExclusions(request, options, wrappedCallback)
