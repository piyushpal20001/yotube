...
exports.UserListCustomerTypeServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/user_list_customer_type_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./user_list_customer_type_service_client_config.json");
...
class UserListCustomerTypeServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    userListCustomerTypeServiceStub;
    /**
     * Construct an instance of UserListCustomerTypeServiceClient.
     *
     ...
     *     const client = new UserListCustomerTypeServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.UserListCustomerTypeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.userListCustomerTypeServiceStub) {
            return this.userListCustomerTypeServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.UserListCustomerTypeService.
        this.userListCustomerTypeServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.UserListCustomerTypeService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.UserListCustomerTypeService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const userListCustomerTypeServiceStubMethods = ['mutateUserListCustomerTypes'];
        for (const methodName of userListCustomerTypeServiceStubMethods) {
            const callPromise = this.userListCustomerTypeServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateUserListCustomerTypes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('mutateUserListCustomerTypes request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateUserListCustomerTypes response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateUserListCustomerTypes(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.userListCustomerTypeServiceStub && !this._terminated) {
            return this.userListCustomerTypeServiceStub.then(stub => {
...
exports.UserListCustomerTypeServiceClient = UserListCustomerTypeServiceClient;
//# sourceMappingURL=user_list_customer_type_service_client.js.map