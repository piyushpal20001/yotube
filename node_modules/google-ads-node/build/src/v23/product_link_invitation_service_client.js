...
exports.ProductLinkInvitationServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/product_link_invitation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./product_link_invitation_service_client_config.json");
...
class ProductLinkInvitationServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    productLinkInvitationServiceStub;
    /**
     * Construct an instance of ProductLinkInvitationServiceClient.
     *
     ...
     *     const client = new ProductLinkInvitationServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ProductLinkInvitationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.productLinkInvitationServiceStub) {
            return this.productLinkInvitationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.ProductLinkInvitationService.
        this.productLinkInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ProductLinkInvitationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ProductLinkInvitationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const productLinkInvitationServiceStubMethods = ['createProductLinkInvitation', 'updateProductLinkInvitation', 'removeProductLinkInvitation'];
        for (const methodName of productLinkInvitationServiceStubMethods) {
            const callPromise = this.productLinkInvitationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createProductLinkInvitation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('createProductLinkInvitation response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.createProductLinkInvitation(request, options, wrappedCallback)
    ...
    updateProductLinkInvitation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('updateProductLinkInvitation response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.updateProductLinkInvitation(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updateProductLinkInvitation response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    removeProductLinkInvitation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('removeProductLinkInvitation response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.removeProductLinkInvitation(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeProductLinkInvitation response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
     ...
     */
    close() {
        if (this.productLinkInvitationServiceStub && !this._terminated) {
            return this.productLinkInvitationServiceStub.then(stub => {
...
exports.ProductLinkInvitationServiceClient = ProductLinkInvitationServiceClient;
//# sourceMappingURL=product_link_invitation_service_client.js.map