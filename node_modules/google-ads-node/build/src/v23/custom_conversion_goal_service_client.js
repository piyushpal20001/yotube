 ...
 * `src/v23/custom_conversion_goal_service_client_config.json`.
...
class CustomConversionGoalServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    customConversionGoalServiceStub;
    /**
     ...
     *     const client = new CustomConversionGoalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomConversionGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomConversionGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomConversionGoalService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomConversionGoals(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomConversionGoals request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomConversionGoals response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomConversionGoals(request, options, wrappedCallback)
