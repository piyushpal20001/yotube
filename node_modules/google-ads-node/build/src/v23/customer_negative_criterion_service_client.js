 ...
 * `src/v23/customer_negative_criterion_service_client_config.json`.
...
class CustomerNegativeCriterionServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    customerNegativeCriterionServiceStub;
    /**
     ...
     *     const client = new CustomerNegativeCriterionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerNegativeCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerNegativeCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerNegativeCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerNegativeCriterionService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerNegativeCriteria(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomerNegativeCriteria request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerNegativeCriteria response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerNegativeCriteria(request, options, wrappedCallback)
