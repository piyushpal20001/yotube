...
exports.GoalServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./goal_service_client_config.json");
...
class GoalServiceClient {
    ...
    goalServiceStub;
    /**
     * Construct an instance of GoalServiceClient.
     *
     ...
     *     const client = new GoalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.GoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.goalServiceStub) {
            return this.goalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.GoalService.
        this.goalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.GoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.GoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const goalServiceStubMethods = ['mutateGoals'];
        for (const methodName of goalServiceStubMethods) {
            const callPromise = this.goalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateGoals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('mutateGoals request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateGoals response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateGoals(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.goalServiceStub && !this._terminated) {
            return this.goalServiceStub.then(stub => {
...
exports.GoalServiceClient = GoalServiceClient;
//# sourceMappingURL=goal_service_client.js.map