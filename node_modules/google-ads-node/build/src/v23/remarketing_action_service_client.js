 ...
 * `src/v23/remarketing_action_service_client_config.json`.
...
class RemarketingActionServiceClient {
     ...
     *     const client = new RemarketingActionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.RemarketingActionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.remarketingActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.RemarketingActionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.RemarketingActionService, this._opts, this._providedCustomServicePath);
    ...
    mutateRemarketingActions(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateRemarketingActions request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateRemarketingActions response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateRemarketingActions(request, options, wrappedCallback)
