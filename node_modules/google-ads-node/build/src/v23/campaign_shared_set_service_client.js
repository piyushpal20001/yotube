 ...
 * `src/v23/campaign_shared_set_service_client_config.json`.
...
class CampaignSharedSetServiceClient {
     ...
     *     const client = new CampaignSharedSetServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignSharedSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignSharedSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignSharedSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignSharedSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignSharedSets(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCampaignSharedSets request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCampaignSharedSets response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCampaignSharedSets(request, options, wrappedCallback)
