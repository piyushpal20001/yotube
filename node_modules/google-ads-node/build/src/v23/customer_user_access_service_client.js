 ...
 * `src/v23/customer_user_access_service_client_config.json`.
...
class CustomerUserAccessServiceClient {
     ...
     *     const client = new CustomerUserAccessServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerUserAccessService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerUserAccessServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerUserAccessService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerUserAccessService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerUserAccess(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomerUserAccess request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomerUserAccess response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomerUserAccess(request, options, wrappedCallback)
