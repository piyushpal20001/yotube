 ...
 * `src/v23/bidding_strategy_service_client_config.json`.
...
class BiddingStrategyServiceClient {
     ...
     *     const client = new BiddingStrategyServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.BiddingStrategyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.biddingStrategyServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.BiddingStrategyService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.BiddingStrategyService, this._opts, this._providedCustomServicePath);
    ...
    mutateBiddingStrategies(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateBiddingStrategies request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateBiddingStrategies response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateBiddingStrategies(request, options, wrappedCallback)
