 ...
 * `src/v23/batch_job_service_client_config.json`.
...
class BatchJobServiceClient {
     ...
     *     const client = new BatchJobServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        if (opts.fallback) {
            ...
            lroOptions.httpRules = [{ selector: 'google.longrunning.Operations.CancelOperation', post: '/v23/{name=customers/*/operations/*}:cancel', body: '*', }, { selector: 'google.longrunning.Operations.DeleteOperation', delete: '/v23/{name=customers/*/operations/*}', }, { selector: 'google.longrunning.Operations.GetOperation', get: '/v23/{name=customers/*/operations/*}', }, { selector: 'google.longrunning.Operations.ListOperations', get: '/v23/{name=customers/*/operations}', }, { selector: 'google.longrunning.Operations.WaitOperation', post: '/v23/{name=customers/*/operations/*}:wait', body: '*', }];
        }
        this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
        const runBatchJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const runBatchJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v23.resources.BatchJob.BatchJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.BatchJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.BatchJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.BatchJobService, this._opts, this._providedCustomServicePath);
     ...
     * @example <caption>include:samples/generated/v23/batch_job_service.run_batch_job.js</caption>
     * region_tag:googleads_v23_generated_BatchJobService_RunBatchJob_async
     */
    ...
    /**
     * Equivalent to `listBatchJobResults`, but returns a NodeJS Stream object.
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.ads.googleads.v23.services.BatchJobResult|BatchJobResult} on 'data' event.
     ...
     *   {@link protos.google.ads.googleads.v23.services.BatchJobResult|BatchJobResult}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v23/batch_job_service.list_batch_job_results.js</caption>
     * region_tag:googleads_v23_generated_BatchJobService_ListBatchJobResults_async
     */
