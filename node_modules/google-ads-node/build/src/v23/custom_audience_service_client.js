 ...
 * `src/v23/custom_audience_service_client_config.json`.
...
class CustomAudienceServiceClient {
     ...
     *     const client = new CustomAudienceServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomAudienceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customAudienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomAudienceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomAudienceService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomAudiences(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCustomAudiences request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCustomAudiences response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCustomAudiences(request, options, wrappedCallback)
