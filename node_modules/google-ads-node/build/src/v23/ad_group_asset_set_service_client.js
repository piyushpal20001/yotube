...
exports.AdGroupAssetSetServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/ad_group_asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ad_group_asset_set_service_client_config.json");
...
class AdGroupAssetSetServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    adGroupAssetSetServiceStub;
    /**
     * Construct an instance of AdGroupAssetSetServiceClient.
     *
     ...
     *     const client = new AdGroupAssetSetServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AdGroupAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.adGroupAssetSetServiceStub) {
            return this.adGroupAssetSetServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.AdGroupAssetSetService.
        this.adGroupAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AdGroupAssetSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AdGroupAssetSetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupAssetSetServiceStubMethods = ['mutateAdGroupAssetSets'];
        for (const methodName of adGroupAssetSetServiceStubMethods) {
            const callPromise = this.adGroupAssetSetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAdGroupAssetSets(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('mutateAdGroupAssetSets request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAdGroupAssetSets response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAdGroupAssetSets(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.adGroupAssetSetServiceStub && !this._terminated) {
            return this.adGroupAssetSetServiceStub.then(stub => {
...
exports.AdGroupAssetSetServiceClient = AdGroupAssetSetServiceClient;
//# sourceMappingURL=ad_group_asset_set_service_client.js.map