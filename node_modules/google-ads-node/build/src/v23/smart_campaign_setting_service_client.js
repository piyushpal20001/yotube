 ...
 * `src/v23/smart_campaign_setting_service_client_config.json`.
...
class SmartCampaignSettingServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    smartCampaignSettingServiceStub;
    /**
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.SmartCampaignSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.smartCampaignSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.SmartCampaignSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.SmartCampaignSettingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const smartCampaignSettingServiceStubMethods = ['getSmartCampaignStatus', 'mutateSmartCampaignSettings'];
    ...
    getSmartCampaignStatus(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
