...
exports.IdentityVerificationServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/identity_verification_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./identity_verification_service_client_config.json");
...
class IdentityVerificationServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    identityVerificationServiceStub;
    /**
     * Construct an instance of IdentityVerificationServiceClient.
     *
     ...
     *     const client = new IdentityVerificationServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.IdentityVerificationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.identityVerificationServiceStub) {
            return this.identityVerificationServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.IdentityVerificationService.
        this.identityVerificationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.IdentityVerificationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.IdentityVerificationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const identityVerificationServiceStubMethods = ['startIdentityVerification', 'getIdentityVerification'];
        for (const methodName of identityVerificationServiceStubMethods) {
            const callPromise = this.identityVerificationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    startIdentityVerification(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('startIdentityVerification response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.startIdentityVerification(request, options, wrappedCallback)
    ...
    getIdentityVerification(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getIdentityVerification response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getIdentityVerification(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getIdentityVerification response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
     ...
     */
    close() {
        if (this.identityVerificationServiceStub && !this._terminated) {
            return this.identityVerificationServiceStub.then(stub => {
...
exports.IdentityVerificationServiceClient = IdentityVerificationServiceClient;
//# sourceMappingURL=identity_verification_service_client.js.map