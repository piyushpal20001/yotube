 ...
 * `src/v23/google_ads_service_client_config.json`.
...
class GoogleAdsServiceClient {
     ...
     *     const client = new GoogleAdsServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            searchStream: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries)
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.GoogleAdsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.googleAdsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.GoogleAdsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.GoogleAdsService, this._opts, this._providedCustomServicePath);
     ...
     * @param {google.ads.googleads.v23.enums.SummaryRowSettingEnum.SummaryRowSetting} request.summaryRowSetting
     ...
     * @returns {Stream}
     *   An object stream which emits {@link protos.google.ads.googleads.v23.services.SearchGoogleAdsStreamResponse|SearchGoogleAdsStreamResponse} on 'data' event.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#server-streaming | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v23/google_ads_service.search_stream.js</caption>
     * region_tag:googleads_v23_generated_GoogleAdsService_SearchStream_async
     */
     ...
     * @param {google.ads.googleads.v23.services.SearchSettings} request.searchSettings
     *   Settings that allow users to specify request count, summary row, and
     *   results behavior.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.ads.googleads.v23.services.GoogleAdsRow|GoogleAdsRow} on 'data' event.
     ...
     *   {@link protos.google.ads.googleads.v23.services.GoogleAdsRow|GoogleAdsRow}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v23/google_ads_service.search.js</caption>
     * region_tag:googleads_v23_generated_GoogleAdsService_Search_async
     */
