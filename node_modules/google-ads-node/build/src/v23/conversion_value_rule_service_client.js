 ...
 * `src/v23/conversion_value_rule_service_client_config.json`.
...
class ConversionValueRuleServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    conversionValueRuleServiceStub;
    /**
     ...
     *     const client = new ConversionValueRuleServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ConversionValueRuleService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionValueRuleServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ConversionValueRuleService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ConversionValueRuleService, this._opts, this._providedCustomServicePath);
    ...
    mutateConversionValueRules(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateConversionValueRules request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateConversionValueRules response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateConversionValueRules(request, options, wrappedCallback)
