 ...
 * `src/v23/keyword_plan_campaign_service_client_config.json`.
...
class KeywordPlanCampaignServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    keywordPlanCampaignServiceStub;
    /**
     ...
     *     const client = new KeywordPlanCampaignServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.KeywordPlanCampaignService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanCampaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.KeywordPlanCampaignService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.KeywordPlanCampaignService, this._opts, this._providedCustomServicePath);
    ...
    mutateKeywordPlanCampaigns(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateKeywordPlanCampaigns response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateKeywordPlanCampaigns(request, options, wrappedCallback)
