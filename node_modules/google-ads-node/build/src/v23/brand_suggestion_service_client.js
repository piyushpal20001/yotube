...
exports.BrandSuggestionServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/brand_suggestion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./brand_suggestion_service_client_config.json");
...
class BrandSuggestionServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    brandSuggestionServiceStub;
    /**
     * Construct an instance of BrandSuggestionServiceClient.
     *
     ...
     *     const client = new BrandSuggestionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.BrandSuggestionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.brandSuggestionServiceStub) {
            return this.brandSuggestionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.BrandSuggestionService.
        this.brandSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.BrandSuggestionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.BrandSuggestionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const brandSuggestionServiceStubMethods = ['suggestBrands'];
        for (const methodName of brandSuggestionServiceStubMethods) {
            const callPromise = this.brandSuggestionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    suggestBrands(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('suggestBrands request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('suggestBrands response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.suggestBrands(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.brandSuggestionServiceStub && !this._terminated) {
            return this.brandSuggestionServiceStub.then(stub => {
...
exports.BrandSuggestionServiceClient = BrandSuggestionServiceClient;
//# sourceMappingURL=brand_suggestion_service_client.js.map