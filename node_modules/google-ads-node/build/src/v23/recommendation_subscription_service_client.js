...
exports.RecommendationSubscriptionServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/recommendation_subscription_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./recommendation_subscription_service_client_config.json");
...
class RecommendationSubscriptionServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    recommendationSubscriptionServiceStub;
    /**
     * Construct an instance of RecommendationSubscriptionServiceClient.
     *
     ...
     *     const client = new RecommendationSubscriptionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.RecommendationSubscriptionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.recommendationSubscriptionServiceStub) {
            return this.recommendationSubscriptionServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.RecommendationSubscriptionService.
        this.recommendationSubscriptionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.RecommendationSubscriptionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.RecommendationSubscriptionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const recommendationSubscriptionServiceStubMethods = ['mutateRecommendationSubscription'];
        for (const methodName of recommendationSubscriptionServiceStubMethods) {
            const callPromise = this.recommendationSubscriptionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateRecommendationSubscription(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateRecommendationSubscription response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateRecommendationSubscription(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.recommendationSubscriptionServiceStub && !this._terminated) {
            return this.recommendationSubscriptionServiceStub.then(stub => {
...
exports.RecommendationSubscriptionServiceClient = RecommendationSubscriptionServiceClient;
//# sourceMappingURL=recommendation_subscription_service_client.js.map