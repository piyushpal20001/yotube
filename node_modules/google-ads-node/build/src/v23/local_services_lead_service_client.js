...
exports.LocalServicesLeadServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/local_services_lead_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./local_services_lead_service_client_config.json");
...
class LocalServicesLeadServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    localServicesLeadServiceStub;
    /**
     * Construct an instance of LocalServicesLeadServiceClient.
     *
     ...
     *     const client = new LocalServicesLeadServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.LocalServicesLeadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.localServicesLeadServiceStub) {
            return this.localServicesLeadServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.LocalServicesLeadService.
        this.localServicesLeadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.LocalServicesLeadService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.LocalServicesLeadService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const localServicesLeadServiceStubMethods = ['appendLeadConversation', 'provideLeadFeedback'];
        for (const methodName of localServicesLeadServiceStubMethods) {
            const callPromise = this.localServicesLeadServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    appendLeadConversation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    provideLeadFeedback(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.LocalServicesLeadServiceClient = LocalServicesLeadServiceClient;
//# sourceMappingURL=local_services_lead_service_client.js.map