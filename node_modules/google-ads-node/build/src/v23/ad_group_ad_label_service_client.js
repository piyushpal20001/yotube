 ...
 * `src/v23/ad_group_ad_label_service_client_config.json`.
...
class AdGroupAdLabelServiceClient {
     ...
     *     const client = new AdGroupAdLabelServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AdGroupAdLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupAdLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AdGroupAdLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AdGroupAdLabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupAdLabels(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateAdGroupAdLabels request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAdGroupAdLabels response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAdGroupAdLabels(request, options, wrappedCallback)
