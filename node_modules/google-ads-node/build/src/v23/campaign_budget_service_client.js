 ...
 * `src/v23/campaign_budget_service_client_config.json`.
...
class CampaignBudgetServiceClient {
     ...
     *     const client = new CampaignBudgetServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignBudgetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignBudgetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignBudgetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignBudgetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignBudgets(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateCampaignBudgets request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCampaignBudgets response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCampaignBudgets(request, options, wrappedCallback)
