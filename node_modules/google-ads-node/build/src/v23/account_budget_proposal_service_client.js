 ...
 * `src/v23/account_budget_proposal_service_client_config.json`.
...
class AccountBudgetProposalServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    accountBudgetProposalServiceStub;
    /**
     ...
     *     const client = new AccountBudgetProposalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.AccountBudgetProposalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountBudgetProposalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.AccountBudgetProposalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.AccountBudgetProposalService, this._opts, this._providedCustomServicePath);
    ...
    mutateAccountBudgetProposal(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateAccountBudgetProposal response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateAccountBudgetProposal(request, options, wrappedCallback)
