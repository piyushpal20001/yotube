 ...
 * `src/v23/shared_criterion_service_client_config.json`.
...
class SharedCriterionServiceClient {
     ...
     *     const client = new SharedCriterionServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.SharedCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sharedCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.SharedCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.SharedCriterionService, this._opts, this._providedCustomServicePath);
    ...
    mutateSharedCriteria(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateSharedCriteria request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateSharedCriteria response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateSharedCriteria(request, options, wrappedCallback)
