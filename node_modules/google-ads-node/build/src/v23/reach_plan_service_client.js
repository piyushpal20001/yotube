 ...
 * `src/v23/reach_plan_service_client_config.json`.
...
class ReachPlanServiceClient {
     ...
     *     const client = new ReachPlanServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ReachPlanService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reachPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ReachPlanService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ReachPlanService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reachPlanServiceStubMethods = ['generateConversionRates', 'listPlannableLocations', 'listPlannableProducts', 'generateReachForecast', 'listPlannableUserLists', 'listPlannableUserInterests'];
    ...
    generateConversionRates(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    listPlannableLocations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listPlannableLocations response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listPlannableLocations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableLocations response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    listPlannableProducts(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listPlannableProducts response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listPlannableProducts(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableProducts response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    generateReachForecast(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('generateReachForecast response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.generateReachForecast(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateReachForecast response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    listPlannableUserLists(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        this.initialize().catch(err => { throw err; });
        this._log.info('listPlannableUserLists request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listPlannableUserLists response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listPlannableUserLists(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableUserLists response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    listPlannableUserInterests(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        this.initialize().catch(err => { throw err; });
        this._log.info('listPlannableUserInterests request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('listPlannableUserInterests response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.listPlannableUserInterests(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableUserInterests response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
