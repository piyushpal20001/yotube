 ...
 * `src/v23/geo_target_constant_service_client_config.json`.
...
class GeoTargetConstantServiceClient {
     ...
     *     const client = new GeoTargetConstantServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.GeoTargetConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.geoTargetConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.GeoTargetConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.GeoTargetConstantService, this._opts, this._providedCustomServicePath);
    ...
    suggestGeoTargetConstants(request, optionsOrCallback, callback) {
        ...
        this._log.info('suggestGeoTargetConstants request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('suggestGeoTargetConstants response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.suggestGeoTargetConstants(request, options, wrappedCallback)
