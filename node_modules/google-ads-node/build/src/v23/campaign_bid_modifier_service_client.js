 ...
 * `src/v23/campaign_bid_modifier_service_client_config.json`.
...
class CampaignBidModifierServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    campaignBidModifierServiceStub;
    /**
     ...
     *     const client = new CampaignBidModifierServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CampaignBidModifierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CampaignBidModifierService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CampaignBidModifierService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignBidModifiers(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateCampaignBidModifiers response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateCampaignBidModifiers(request, options, wrappedCallback)
