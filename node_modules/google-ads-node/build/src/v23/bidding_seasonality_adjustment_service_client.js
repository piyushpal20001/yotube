 ...
 * `src/v23/bidding_seasonality_adjustment_service_client_config.json`.
...
class BiddingSeasonalityAdjustmentServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    biddingSeasonalityAdjustmentServiceStub;
    /**
     ...
     *     const client = new BiddingSeasonalityAdjustmentServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.BiddingSeasonalityAdjustmentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.biddingSeasonalityAdjustmentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.BiddingSeasonalityAdjustmentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.BiddingSeasonalityAdjustmentService, this._opts, this._providedCustomServicePath);
    ...
    mutateBiddingSeasonalityAdjustments(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateBiddingSeasonalityAdjustments response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateBiddingSeasonalityAdjustments(request, options, wrappedCallback)
