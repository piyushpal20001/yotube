...
exports.ShareablePreviewServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/shareable_preview_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./shareable_preview_service_client_config.json");
...
class ShareablePreviewServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    shareablePreviewServiceStub;
    /**
     * Construct an instance of ShareablePreviewServiceClient.
     *
     ...
     *     const client = new ShareablePreviewServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ShareablePreviewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.shareablePreviewServiceStub) {
            return this.shareablePreviewServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.ShareablePreviewService.
        this.shareablePreviewServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ShareablePreviewService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ShareablePreviewService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const shareablePreviewServiceStubMethods = ['generateShareablePreviews'];
        for (const methodName of shareablePreviewServiceStubMethods) {
            const callPromise = this.shareablePreviewServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateShareablePreviews(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('generateShareablePreviews response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.generateShareablePreviews(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.shareablePreviewServiceStub && !this._terminated) {
            return this.shareablePreviewServiceStub.then(stub => {
...
exports.ShareablePreviewServiceClient = ShareablePreviewServiceClient;
//# sourceMappingURL=shareable_preview_service_client.js.map