 ...
 * `src/v23/conversion_custom_variable_service_client_config.json`.
...
class ConversionCustomVariableServiceClient {
     ...
     *     const client = new ConversionCustomVariableServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.ConversionCustomVariableService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionCustomVariableServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.ConversionCustomVariableService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.ConversionCustomVariableService, this._opts, this._providedCustomServicePath);
    ...
    mutateConversionCustomVariables(request, optionsOrCallback, callback) {
        ...
        this._log.info('mutateConversionCustomVariables request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('mutateConversionCustomVariables response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.mutateConversionCustomVariables(request, options, wrappedCallback)
