...
exports.CustomerLifecycleGoalServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v23/customer_lifecycle_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./customer_lifecycle_goal_service_client_config.json");
...
class CustomerLifecycleGoalServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    customerLifecycleGoalServiceStub;
    /**
     * Construct an instance of CustomerLifecycleGoalServiceClient.
     *
     ...
     *     const client = new CustomerLifecycleGoalServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v23.services.CustomerLifecycleGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.customerLifecycleGoalServiceStub) {
            return this.customerLifecycleGoalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v23.services.CustomerLifecycleGoalService.
        this.customerLifecycleGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v23.services.CustomerLifecycleGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v23.services.CustomerLifecycleGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerLifecycleGoalServiceStubMethods = ['configureCustomerLifecycleGoals'];
        for (const methodName of customerLifecycleGoalServiceStubMethods) {
            const callPromise = this.customerLifecycleGoalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    configureCustomerLifecycleGoals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('configureCustomerLifecycleGoals request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('configureCustomerLifecycleGoals response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.configureCustomerLifecycleGoals(request, options, wrappedCallback)
     ...
     */
    close() {
        if (this.customerLifecycleGoalServiceStub && !this._terminated) {
            return this.customerLifecycleGoalServiceStub.then(stub => {
...
exports.CustomerLifecycleGoalServiceClient = CustomerLifecycleGoalServiceClient;
//# sourceMappingURL=customer_lifecycle_goal_service_client.js.map